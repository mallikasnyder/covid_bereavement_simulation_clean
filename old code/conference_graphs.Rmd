---
title: 'Wittgenstein Centre Conference Graphs'
output:
  html_document:
    toc: yes
    toc_float: yes
...
In this document, I make the graphs we use for the VID presentation.
...
ggsave(file = "../Output/wcc_figures/kin_dist_wcc.png")
```
...
ggsave(file = "../Output/wcc_figures/prob_loss_wcc.png")
```
...
ggsave(file = "../Output/wcc_figures/kin_loss_wcc.png")
```
...
ggsave(file = "../Output/wcc_figures/ebr_em_wcc.png", width = 20, height = 12, units = "cm")
